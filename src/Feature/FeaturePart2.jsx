...
const FeaturePart2 = () => {
    return (
        <div>
            <div className="hero min-h-screen bg-base-200 -mt-96">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div className="w-1/2">
                    <img src="/nobanno utshob.jpg" className="max-w-sm rounded-lg shadow-2xl" />
                ...
                <div className="w-1/2">
                    ...
                    new rice. The majority of Bangladeshis still live in rural areas 
                    and are heavily dependent on <br /> agriculture. It is the month of 
                    Agrahayon when the rural households <br /> in Bangladesh are filled 
                    with the smell of new rice.</p>
                </div>
            </div>
            </div>
        </div>
